...
class PathPlannerPTP: 
	...
	def plot_results(self, results):
		...
		plt.tight_layout()
		plt.savefig("4567 method.pdf", format="pdf")
		plt.clf()
...
def paper_results():
	...
	path_planner = PathPlannerPTP(delta_robot, [-10, 10, -55], [10, -5, -70], 1)
	...
	# using 4567 planner 
	result_4567 = path_planner.point_to_point_4567()
	path_planner.plot_results(result_4567)
